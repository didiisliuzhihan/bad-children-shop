...
for(const name of ['room_furnished_nest.glb','nest-fireplace-asmr.mp3','default-stamp-white.png',...NEST_TAP_FILES,...RESIDENT_RELEASE_FILES])await fs.copyFile('assets/delivery/'+name,'docs/assets/delivery/'+name);
