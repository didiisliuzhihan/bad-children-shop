...
// Commit touch/pen on release, mouse at threshold. Audio activation is separate:
// some embedded browsers require a plain tap and reject a swipe's release.
export function shouldCommitDrag(progress,pointerType,released=false){return progress>=1&&(pointerType==='mouse'||released)}
